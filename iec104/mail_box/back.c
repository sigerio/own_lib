...
void update_manage_info(void* manage_info, uint8_t info_type, void* info)
{
    list_manage* list_info = (list_manage*)manage_info;
...
int list_err(void list)
{
    list_manage list_info = (list_manage)list;
